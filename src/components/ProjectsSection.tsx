...
const ProjectsSection = () => {
  ...
  const projects = [
    {
      ...
      liveUrl: "https://fashion-hub-36ui.vercel.app/",
      // githubUrl: '#',
      category: "Full Stack",
    },
    {
      id: 2,
      title: "Ecommerce site's swagger",
      description:
    ...
    {
      id: 4,
      title: "Smart Hospital Management Application",
      description:
      ...
      githubUrl:
        "https://github.com/TanjilaShamima/smart-hospital-management-application",
      category: "Full Stack",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      liveUrl: "https://travel-guru-73b71.firebaseapp.com/",
      githubUrl: "https://github.com/TanjilaShamima/new-travel-guru",
      category: "Frontend",
    },
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-br from-blue-50 via-purple-100 to-pink-50 relative overflow-hidden"
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Showcase of my recent work including full-stack applications, APIs,
